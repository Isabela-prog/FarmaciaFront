    ...
    return (
        <div className='container w-1/3 mx-auto'>
            ...
            <div className='border flex flex-col rounded-2xl overflow-hidden justify-between bg-white'>
                <header className='py-2 px-6 bg-lime-200 text-slate-800 font-bold text-2xl'>
                    Categoria
                </header>
                ...
                <div className="flex">
                    ...
                    <button
                        className='w-full text-slate-100 bg-lime-300 hover:bg-lime-400 flex items-center justify-center'
